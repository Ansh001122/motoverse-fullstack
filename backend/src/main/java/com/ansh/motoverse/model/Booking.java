...
@Entity public class Booking {
    ...
    public Booking() {}
    public Booking(Vehicle vehicle, String customerName, String customerEmail, int rentalDays, BigDecimal totalAmount){this.vehicle=vehicle;this.customerName=customerName;this.customerEmail=customerEmail;this.rentalDays=rentalDays;this.totalAmount=totalAmount;this.createdAt=LocalDateTime.now();this.status=BookingStatus.PENDING_PAYMENT;}
